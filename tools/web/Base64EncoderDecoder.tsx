  ...
  const handleEncode = () => {
    try {
      ...
      trackGtagEvent('tool_used', {
        ...
        tool_name: 'base64-encoderdecoder',
        action: 'encode',
      });
    } catch (e) {
    ...
    <div className="space-y-6">
      <div>
        ...
        <textarea
          id="input-text"
          rows={6}
          className="w-full p-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition font-mono"
      ...
      <div>
        ...
        <div className="relative">
          <textarea
            ...
            rows={6}
            readOnly
            className={`w-full p-3 border rounded-lg bg-gray-50 transition font-mono ${error ? 'border-red-500' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'}`}
