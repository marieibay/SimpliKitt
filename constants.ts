...
const allToolsRaw: (Omit<Tool, 'slug' | 'component' | 'icon'>)[] = [
  ...
  { name: 'Delete Pages from PDF', description: 'Remove specific pages or page ranges from a PDF document.', category: 'PDF & Document Tools', instructions: "This tool allows you to remove unwanted pages from a PDF file, creating a new, shorter document.\n1. Upload your PDF file.\n2. In the input box, enter the page numbers or ranges you want to delete (e.g., '2, 4-6, 9').\n3. Click 'Delete Pages & Download' to process the file.\n4. A new PDF with the specified pages removed will be downloaded automatically." },
  ...
  { name: 'Image Mirror Effect', description: 'Creates a reflection effect.', category: 'Image Tools', instructions: "This tool creates a symmetrical reflection of your image, which is great for artistic effects, abstract patterns, or for creating unique visuals. You can control the direction and position of the reflection.\n1. Upload an image.\n2. Select a 'Direction' (Horizontal or Vertical) for the mirror effect.\n3. Choose the 'Reflection Position' to determine which part of the image is reflected.\n4. Download the newly created mirrored image." },
